...
class CompletedTasksPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => CompletedTasksState();
}

class CompletedTasksState extends State<CompletedTasksPage> {
  CompletedTasksBloc _completedTasksBloc;
  ...
  void initState() {
    ...
    _completedTasksBloc = BlocProvider.of<CompletedTasksBloc>(context);
    _completedTasksBloc.getTasks();
  }

  @override
  Widget build(BuildContext context) {
    return StreamBuilder(
      stream: _completedTasksBloc.successSubject,
        ...
        if (snapshot.hasData) {
          return Column(
            ...
            children: [
                    ...
                    Expanded(
                      child: Row(
                        ...
                        children: [
                          InkWell(
                              onTap: () {
                                _completedTasksBloc.viewMapSubject.sink
                                    .add(true);
                              },
                              child: Image.asset(
                                IC_SMALL_MAP,
              ...
              StreamBuilder(
                stream: _completedTasksBloc.viewMapStream,
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: FlatButton.icon(
                        onPressed: () {
                          _completedTasksBloc.sortTypeId = 1;
                          _completedTasksBloc.getTasks();
                  ...
                  Padding(
                    ...
                    child: FlatButton.icon(
                        onPressed: () {
                          _completedTasksBloc.sortTypeId = 2;
                          _completedTasksBloc.getTasks();
                          Navigator.pop(context);
                        },
                  ...
                  Padding(
                    ...
                    child: FlatButton.icon(
                        onPressed: () {
                          _completedTasksBloc.sortTypeId = 3;
                          _completedTasksBloc.getTasks();
                          Navigator.pop(context);
                        },
                  ...
                  Padding(
                    ...
                    child: FlatButton.icon(
                        onPressed: () {
                          _completedTasksBloc.sortTypeId = 4;
                          _completedTasksBloc.getTasks();
                          Navigator.pop(context);
                        },

...
class AvailableTasksBloc extends BlocBase with APIBlocMixin<Tasks, ErrorModel>{
  ...
  getAvailableTasks() async {
    ...
    request.requestStatusLst = AVAILABLE_STATUS;
    request.requestTypeLst = AVAILABLE_TYPE;
